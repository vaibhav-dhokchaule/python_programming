# -*- coding: utf-8 -*-
"""
Created on Sun Jan  2 16:49:39 2022
...
viz_test.ylabel('Weight of person') 
viz_test.show() 


# Predicting the result of 190cm height of person weight
y_pred  = regressor.predict(np.array([190]).reshape(1, 1))
print(y_pred)
